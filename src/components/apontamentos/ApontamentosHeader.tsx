...
export function ApontamentosHeader({ apontamentos, onOpenNewModal }: ApontamentosHeaderProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200/80 dark:border-slate-800">
        <div>
          <div className="flex items-center gap-2 text-indigo-600 dark:text-indigo-400 font-semibold text-xs uppercase tracking-wider">
            <Layers className="h-4 w-4" /> Plataforma Integrada de Projetos
          </div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            Controle de interferências, revisões e compatibilização entre disciplinas técnicas.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Total */}
        <div className="rounded-xl border border-slate-200/80 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/90 shadow-2xs">
        ...
        {/* Abertos */}
        <div className="rounded-xl border border-amber-500/20 bg-amber-50/40 p-4 dark:border-amber-800/30 dark:bg-amber-950/20 shadow-2xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-amber-700 dark:text-amber-300 uppercase tracking-wider">Abertos</span>
        ...
        {/* Resolvidos */}
        <div className="rounded-xl border border-emerald-500/20 bg-emerald-50/40 p-4 dark:border-emerald-800/30 dark:bg-emerald-950/20 shadow-2xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-emerald-700 dark:text-emerald-300 uppercase tracking-wider">Resolvidos</span>
        ...
        {/* Alta Prioridade */}
        <div className="rounded-xl border border-rose-500/20 bg-rose-50/40 p-4 dark:border-rose-800/30 dark:bg-rose-950/20 shadow-2xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-rose-700 dark:text-rose-300 uppercase tracking-wider">Alta Prioridade</span>
