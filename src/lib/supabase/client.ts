...
export const MOCK_APONTAMENTOS: Apontamento[] = [
  {
    ...
    solucao: 'Desviar o duto de exaustão em 45° contornando a viga pela esquerda ou prever furação reforçada conforme diretriz do calculista.',
  ...
  },
  {
    ...
    solucao: 'Ajustar a arquitetura criando uma carenagem em gesso acartonado (drywall) para embutir as prumadas sem alterar blocos estruturais.',
  ...
  },
  {
    ...
    solucao: 'Redimensionado disjuntor geral de 400A para 630A e atualizada a especificação do barramento no projeto executivo de elétrica.',
